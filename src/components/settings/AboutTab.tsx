...
const STEPS: { n: number; title: string; body: string }[] = [
  ...
  { n: 3, title: "Parse", body: "The app sends each artefact's data and image to your configured AI provider. For each catalogue field, the AI generates suggestions ranked by confidence." },
  { n: 4, title: "Review", body: "Each catalogue field shows a combined dropdown — AI suggestions first (sorted by confidence), followed by vocabulary list terms. Select a value, search, or type a custom entry. You make the final call." },
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <Card>
          <CardContent className="flex flex-col gap-1.5 py-4">
            <div className="mb-1.5 flex items-center gap-2 text-sm font-semibold"><Cpu className="size-3.5" /><span>AI Provider</span></div>
            <div className="text-muted-foreground text-[13px] leading-relaxed">
              Connects to any OpenAI-compatible API. Requests are made from the app process on your machine; your API key is stored locally beside the app and is never sent anywhere except your configured endpoint.
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex flex-col gap-1.5 py-4">
            ...
            <div className="text-muted-foreground text-[13px] leading-relaxed">
              All settings stay in a single file beside the app. Only the artefact data you actively submit is sent to your configured AI endpoint.
            </div>
          </CardContent>
        </Card>
      </div>
